...
const themes: {
  ...
  netflix: {
    primary: "bg-red-600 dark:text-white text-black",
    secondary: "bg-red-200 text-red-800 dark:text-red-100 dark:bg-red-900",
    text: "text-gray-800 dark:text-white",
    background: "bg-black dark:bg-gray-900",
  },
};
...
export default function Yakkshit() {
...
const downloadPDF = () => {
  ...
  if (input) {
    toast.info("Try to download file in light mode and prefer to downloading in desktop device", {
      position: "top-right",
      autoClose: 5000,
